...
- Crie uma função para transformar a lista de objetos em um arquivo JSON
- Crie uma função para ler o arquivo JSON
- Crie uma função para mostrar os dados de maneira organizada no terminal
